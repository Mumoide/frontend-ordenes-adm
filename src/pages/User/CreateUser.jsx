...
function CreateUser() {
  ...
  const handleSubmit = (event) => {
    ...
    if (
      ...
      if (data.lastName === "") {
        setLastNameMessage("Se requiere apellido");
      }
    ...
    if (
      ...
      if (data.birthDate === "") {
        setBirthDateMessage("Se requiere fecha de nacimiento");
      }
      hasError = true;
    } else {
    ...
    axios
      ...
      .catch((err) => {
        ...
        if (err.response.data.message.error === "rut existente") {
          notifyError(err.response.data.message.message);
          return;
        }

        if (err.response.data.message.error === "email existente") {
          notifyError(err.response.data.message.message);
          return;
        }
      });
  ...
  return (
    <div className="d-flex flex-column mx-auto align-items-center pt-2 mt-3 border  w-75">
      ...
      <form className="row g-3 p-4" onSubmit={handleSubmit} id="myForm">
